...
const NotStartedTodos = ({ todos, status, handleNotStartedTodosCards }) => {
  ...
  const pageCount = Math.ceil(notStartedTodos.length / todosPerPage);
  const displayTodos = notStartedTodos
    ...
    <div className="px-4">
      ...
      >
        <div className="w-[57.5rem] flex justify-between items-center">
          <h1 className="text-2xl text-slate-700">NOT STARTED TODOS</h1>
          <div>
            <IoGridOutline
